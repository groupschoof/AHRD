...
@XmlType(name = "", propOrder = { "hspNum", "hspBitScore", "hspScore",
		"hspEvalue", "hspQueryFrom", "hspQueryTo", "hspHitFrom", "hspHitTo",
		"hspPatternFrom", "hspPatternTo", "hspQueryFrame", "hspHitFrame",
		"hspIdentity", "hspPositive", "hspGaps", "hspAlignLen", "hspDensity",
...
public class Hsp implements Comparable<Hsp> {
	...
	/**
	 * Enables sorting of HSPs based on their BLAST result E-Value.
	 */
	@Override
	public int compareTo(Hsp o) {
		return this.getHspEvalue().compareTo(o.getHspEvalue());
	}
