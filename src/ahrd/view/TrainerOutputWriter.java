...
public class TrainerOutputWriter {
	...
	public String generateHeader(boolean isFinalOutput) {
		...
		hdr += "\tAverage Precision\tAverage Recall\tToken-Score-Bit-Score-Weight\tToken-Score-Database-Score-Weight\tToken-Score-Overlap-Score-Weight\tGo-Term-Score-Evidence-Code-Score-Weight";
