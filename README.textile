...
h4. 2.6.1 Parameter Optimization via Genetic Algorithm
...
h4. 2.6.1 Parameter Optimization via Simulated Annealing
...
h4. 2.6.3 Optimization in parallel (Trainer-Batcher)
