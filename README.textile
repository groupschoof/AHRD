...
described in this article: ??Lee, Byungwook, and Doheon Lee. “Protein
Comparison at the Domain Architecture Level.” BMC Bioinformatics 10, no. Suppl
15 (December 3, 2009): S5.??  The following parameter decides how AHRD should
compute domain architecture similarity. Based on Pfam or InterPro
annotations:<pre>compute_domain_similarity_on: pfam</pre> If you want o use
