...
Alternativelly without using @git@, you can download AHRD version @v3.11@ ("zip":https://github.com/groupschoof/AHRD/archive/v3.11.zip or "tar.gz":https://github.com/groupschoof/AHRD/archive/v3.11.tar.gz) and extract it.
