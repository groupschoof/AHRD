...
## Reject those matched by any regex given in ./test/resources/blacklist_descline.txt,
## delete those parts of each description line, matching any regex in ./test/resources/filter_descline_sprot.txt. 
...
h2. Building an executable jar:

<pre>ant dist</pre> will create the executable JAR-File:
<pre>./dist/ahrd.jar</pre>
