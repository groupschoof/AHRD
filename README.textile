...
<pre>seqkit fx2tab -nl uniref90.fasta.gz > uniref90.fasta.tsv.gz</pre>Make sure to use the ".tsv" or ".tsv.gz" suffix so AHRD can recognize the file format correctly.
