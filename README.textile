...
# Set the Blast database specific regular expression, used to extract the short accessions from logn ones with @short_accession_regex:@ For example for TAIR10, use @short_accession_regex: "^(?<shortAccession>[^\\.]+)(\\.\\d+)?$"@.
