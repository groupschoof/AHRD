...
# Input yml with all settings and parameters (see section Parameters)
# Blacklists and filters (they can either be used as provided or can be adapted to your needs and database)
## Description blacklist
## Token blacklist
## Description filter for each single blast database
