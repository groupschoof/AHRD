...
Optionally domain search results from InterProScan and Gene Ontology information 
can be given as additional input to improve the results.
...
h4. 2.3.1 Recommended BLAST-Search
