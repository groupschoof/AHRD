...
This can greatly reduce the runtime of AHRD's annotation ("2.1":#21-ahrd-example-usages), evaluation ("2.6":#2.6-computing-f-Scores-for-selected-parameter-sets) and optimization ("2.7":#27-parameter-optimization). However it can not speed up the input of large datasets.
