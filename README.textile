...
## "Logging Messages":#28-logging-messages
...
Instead of using the NCBI's BLAST command line application we recommend "Diamond":https://github.com/bbuchfink/diamond.
It offers an impressive speed up and great scalability while maintaining the sensitivity of BLAST[1].

* The reference databases that were searched
These should usually be FASTA formated.
Providers of database often distribute them in the compressed gzip format.
AHRD is able to recognize and directly parse gzipped databases, so you don't have to spend the time and storage space to unpack them.
If large databases (UniProt/TrEMBL, UniProt/uniref90, NCBI nr) are used, parsing them becomes a very time intensive step in AHRD.
To speed this up we recommend using "seqkit":https://github.com/shenwei356/seqkit to create a smaller tsv file containing only the information AHRD needs:
<pre>seqkit fx2tab -nl uniref90.fasta.gz -o uniref90.fasta.tsv.gz</pre>Make sure to use the ".tsv" or ".tsv.gz" suffix so AHRD can recognize the file format correctly.
...
h3. 2.8 Logging Messages

AHRD pushes messages to stdout and stderr in accordance to 7 levels of importance:

<pre>SEVERE (highest value)
WARNING
INFO (default)
CONFIG
FINE
FINER
FINEST (lowest value)</pre>

They can be specified using the @logging_level@ YML-key.

Using "ALL" shows all levels and logging can also be completely deactivated using "OFF".
...
fn1. Buchfink B, Reuter K, Drost HG, "Sensitive protein alignments at tree-of-life scale using DIAMOND", Nature Methods 18, 366–368 (2021). "doi:10.1038/s41592-021-01101-x":https://doi.org/10.1038/s41592-021-01101-x

High quality genome projects that used AHRD:

fn2. Young, Nevin D., Frédéric Debellé, Giles E. D. Oldroyd, Rene Geurts, Steven B. Cannon, Michael K. Udvardi, Vagner A. Benedito, et al. “The Medicago Genome Provides Insight into the Evolution of Rhizobial Symbioses.” Nature 480, no. 7378 (December 22, 2011): 520–24. "doi:10.1038/nature10625":https://doi.org/10.1038/nature10625

fn3. The Tomato Genome Consortium. “The Tomato Genome Sequence Provides Insights into Fleshy Fruit Evolution.” Nature 485, no. 7400 (May 31, 2012): 635–41. "doi:10.1038/nature11119":https://doi.org/10.1038/nature11119

fn4. International Wheat Genome Sequencing Consortium (IWGSC). “A Chromosome-Based Draft Sequence of the Hexaploid Bread Wheat (Triticum Aestivum) Genome.” Science (New York, N.Y.) 345, no. 6194 (July 18, 2014): 1251788. "doi:10.1126/science.1251788":https://doi.org/10.1126/science.1251788

fn5. International Barley Genome Sequencing Consortium, Klaus F. X. Mayer, Robbie Waugh, John W. S. Brown, Alan Schulman, Peter Langridge, Matthias Platzer, et al. “A Physical, Genetic and Functional Sequence Assembly of the Barley Genome.” Nature 491, no. 7426 (November 29, 2012): 711–16. "doi:10.1038/nature11543":https://doi.org/10.1038/nature11543

fn6. Wang, W., G. Haberer, H. Gundlach, C. Gläßer, T. Nussbaumer, M. C. Luo, A. Lomsadze, et al. “The Spirodela Polyrhiza Genome Reveals Insights into Its Neotenous Reduction Fast Growth and Aquatic Lifestyle.” Nature Communications 5 (2014): 3311. "doi:10.1038/ncomms4311":https://doi.org/10.1038/ncomms4311

fn7. Guo, Shaogui, Jianguo Zhang, Honghe Sun, Jerome Salse, William J. Lucas, Haiying Zhang, Yi Zheng, et al. “The Draft Genome of Watermelon (Citrullus Lanatus) and Resequencing of 20 Diverse Accessions.” Nature Genetics 45, no. 1 (January 2013): 51–58. "doi:10.1038/ng.2470":https://doi.org/10.1038/ng.2470

AHRD was applied on all plant genomes present in the public database *PlantsDB*:

fn8. Spannagl, Manuel, Thomas Nussbaumer, Kai C. Bader, Mihaela M. Martis, Michael Seidel, Karl G. Kugler, Heidrun Gundlach, and Klaus F. X. Mayer. “PGSB PlantsDB: Updates to the Database Framework for Comparative Plant Genome Research.” Nucleic Acids Research 44, no. D1 (January 4, 2016): D1141–47. "doi:10.1093/nar/gkv1130":https://doi.org/10.1093/nar/gkv1130
