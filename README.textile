...
h4. 3.3 Used Formulae and Parameters:

<img src="http://github.com/asishallab/AHRD/raw/master/images/formulae.jpg" />

h5. 3.4 Above formulae use the following parameters as given in ./test/resources/ahrd_input.yml 

h6. 3.4.1 The weights in formula Token-Score are:  
...
h6. 3.4.2 The weight in formula Lexical-Score is:

<pre>description_score_relative_description_frequency_weight: 0.6 </pre>

h6. 3.4.3 The weight in formula Description-Score also is Blast-database specific:
